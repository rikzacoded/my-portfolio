...
//   </p>
// <p className="text-sm sm:text-base md:text-lg leading-relaxed text-purple-700">Here is the link: <br/> <a href = "https://netflix-hvon2sfcf-rikzprogs-projects.vercel.app/"></a></p>
// </section>
